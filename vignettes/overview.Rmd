...
| `compute_ice_pdp()`   | Function that computes Individual Conditional Expectation (ICE) and Partial Dependence Plots (PDP) |
...
| `dynforestpdp`                  | Plot Partial Dependence and Individual Conditional Expectation curves |

| `print()` | Function to print object of class `dynforest`, `dynforestoob`, `dynforestvimp`, `dynforestgvimp`, `dynforestvardepth`, `dynforestpred` and `dynforestpdp` |
