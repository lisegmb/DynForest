...
```{r, eval = FALSE, echo = TRUE}
# compute ice and pdp for two values of the age
ice_pdp_age <- compute_ice_pdp(
...
plot(ice_pdp_age, type = "both")
```


```{r, echo=FALSE, fig.show = 'hold', fig.align='center'}
knitr::include_graphics("Figures/DynForestR_surv_ICE.png")
knitr::include_graphics("Figures/DynForestR_surv_PDP.png")

```



To go further in analyzing variable effects, you can refer to the vignette specifically designed to explain the functioning of ICE and PDP in dynforest.
